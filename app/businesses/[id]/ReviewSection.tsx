      ...
      {showForm && (
        !user ? (
          <div className="mb-6 p-4 bg-gray-50 rounded-xl flex items-center gap-3">
            ...
            <p className="text-sm text-gray-600 flex-1">You need to be signed in to write a review.</p>
            <Link href="/auth/login" className="shrink-0 text-xs font-bold bg-brand-600 hover:bg-brand-700 text-white px-4 py-2 rounded-lg transition-colors">
              Sign in
            </Link>
          </div>
        ) : !user.screen_name ? (
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-center gap-3">
            ...
            <p className="text-sm text-amber-800 flex-1">You need a screen name to write reviews — it keeps your real identity private.</p>
