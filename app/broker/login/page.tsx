...
export default function BrokerLoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (result === "ok") {
      router.push("/broker");
    } else if (result === "not_broker") {
      setError("No broker account found for this email. Please register or contact admin.");
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
          <h1 className="text-xl font-bold text-gray-900 mb-1">Broker Sign In</h1>
          <p className="text-sm text-gray-500 mb-6">
            Access your listings dashboard.
          </p>
        ...
        <p className="text-center text-xs text-gray-400 mt-5">
          New broker?{" "}
          <Link href="/broker/register" className="underline hover:text-gray-600">
